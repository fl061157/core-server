...
public class BinaryJedisCluster implements JedisCommands, BinaryJedisCommands, BasicCommands, Closeable, DisposableBean {
    ...
    public Collection<byte[]> hvals(byte[] key) {
        return new JedisClusterCommand<Collection<byte[]>>(connectionHandler, timeout, maxRedirections) {
            @Override
    ...
    public ScanResult<Map.Entry<String, String>> hscan(String key, int cursor) {
        return new JedisClusterCommand<ScanResult<Map.Entry<String, String>>>(connectionHandler, timeout, maxRedirections) {
            @Override
